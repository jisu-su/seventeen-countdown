...
initCountdown("January 2, 2027 00:00:00", "clock-wonwoo");
// 1. 카운트다운 로직 (2027년 1월 2일 전역일 기준)
const targetDate = new Date("January 2, 2027 00:00:00").getTime();
...
function updateCountdown() {
    ...
    const clockEl = document.getElementById("clock-wonwoo");
    if(clockEl) {
