...
initCountdown("March 15, 2027 00:00:00", "clock-hoshi");
// 1. 카운트다운 로직 (2027년 3월 15일 전역일 기준)
const targetDate = new Date("March 15, 2027 00:00:00").getTime();
...
function updateCountdown() {
    ...
    const clockEl = document.getElementById("clock-hoshi");
    if(clockEl) {
